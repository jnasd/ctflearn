; This file contains the data used to hide the flag
...
section .data
   ...
   vals1 dq 0x00014c4c5e, 0x005130720c, 0x003e87df91, 0x00340ccb70, 0x00676fa321, \
   ...
   vals2 dq 0x0002f21618, 0x00577d3f68, 0x000c838fda, 0x0068e5cdc4, 0x006314b34d, \
   ...
   vals3 dq 0x0053d9c12d, 0x007e4f6f47, 0x0056084aad, 0x0053ce10aa, 0x00349ef85d, \
   ...
   vals4 dq 0x0051095f4d, 0x000bd6fed3, 0x0021d06bec, 0x0068a2be66, 0x0065b4db28, \
   ...
   flag  dq 0x00a8f10265, 0x00e2b9dd5a, 0x003ed39108, 0x0137df46b0, 0x0163cf89f4, \
...
; data item number is in rdi
; flag data returned in rax
GetFlagEnc:
    mov rax, [flag + rdi*8]
    ret
